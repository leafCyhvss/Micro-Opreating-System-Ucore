...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  800f94:	83 ec 08             	sub    $0x8,%esp
    yield();
  800f97:	e8 95 f2 ff ff       	call   800231 <yield>
    yield();
  800f9c:	e8 90 f2 ff ff       	call   800231 <yield>
    yield();
  800fa1:	e8 8b f2 ff ff       	call   800231 <yield>
    yield();
  800fa6:	e8 86 f2 ff ff       	call   800231 <yield>
    yield();
  800fab:	e8 81 f2 ff ff       	call   800231 <yield>
    yield();
  800fb0:	e8 7c f2 ff ff       	call   800231 <yield>
}
  800fb5:	c9                   	leave  
  800fb6:	c3                   	ret    
...
loop(void) {
  ...
  800fc4:	e8 04 f3 ff ff       	call   8002cd <cprintf>
    while (1);
...
work(void) {
  ...
  80101c:	e8 ac f2 ff ff       	call   8002cd <cprintf>
            exit(0);
  801021:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801028:	e8 a2 f1 ff ff       	call   8001cf <exit>
        }
    }
    exit(-1);
  80102d:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801034:	e8 96 f1 ff ff       	call   8001cf <exit>
...
main(void) {
  ...
  80103f:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801042:	e8 0a f2 ff ff       	call   800251 <getpid>
  801047:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80104c:	e8 9d f1 ff ff       	call   8001ee <fork>
  ...
  80108c:	e8 8f ef ff ff       	call   800020 <__panic>
    ...
    if ((pid2 = fork()) == 0) {
  801091:	e8 58 f1 ff ff       	call   8001ee <fork>
  ...
  8010f3:	e8 28 ef ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  8010f8:	a1 10 20 80 00       	mov    0x802010,%eax
  8010fd:	89 04 24             	mov    %eax,(%esp)
  801100:	e8 39 f1 ff ff       	call   80023e <kill>
    }
    panic("FAIL: T.T\n");
  ...
  80111c:	e8 ff ee ff ff       	call   800020 <__panic>
