...
main(void) {
  ...
  800fde:	e8 3d f0 ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  ...
  801056:	e8 c5 ef ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  ...
  801071:	e8 57 f2 ff ff       	call   8002cd <cprintf>
    cprintf("testbss may pass.\n");
  801076:	c7 04 24 47 14 80 00 	movl   $0x801447,(%esp)
  80107d:	e8 4b f2 ff ff       	call   8002cd <cprintf>
