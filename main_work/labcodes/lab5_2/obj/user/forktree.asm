...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800053:	e8 42 02 00 00       	call   80029a <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 9a 10 80 00 	movl   $0x80109a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 9c 10 80 00 	movl   $0x80109c,(%esp)
  ...
  8000a3:	e8 f2 01 00 00       	call   80029a <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 9a 10 80 00 	movl   $0x80109a,(%esp)
...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 b8 10 80 00 	movl   $0x8010b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 e4 11 80 00       	add    $0x8011e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 08 12 80 00 	mov    0x801208(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 fe 11 80 	movl   $0x8011fe,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be 01 12 80 00       	mov    $0x801201,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  800fa3:	e8 b3 f3 ff ff       	call   80035b <strlen>
  ...
  800fd2:	e8 25 fe ff ff       	call   800dfc <snprintf>
    if (fork() == 0) {
  800fd7:	e8 12 f2 ff ff       	call   8001ee <fork>
  ...
  800fe6:	e8 13 00 00 00       	call   800ffe <forktree>
        yield();
  800feb:	e8 41 f2 ff ff       	call   800231 <yield>
        exit(0);
  800ff0:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800ff7:	e8 d3 f1 ff ff       	call   8001cf <exit>
    }
}
  800ffc:	c9                   	leave  
  800ffd:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  801001:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801004:	e8 48 f2 ff ff       	call   800251 <getpid>
  ...
  80101b:	e8 ad f2 ff ff       	call   8002cd <cprintf>
