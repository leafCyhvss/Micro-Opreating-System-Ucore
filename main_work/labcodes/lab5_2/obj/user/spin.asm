...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800053:	e8 42 02 00 00       	call   80029a <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 dc 10 80 00 	movl   $0x8010dc,(%esp)
  ...
  8000a3:	e8 f2 01 00 00       	call   80029a <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 da 10 80 00 	movl   $0x8010da,(%esp)
...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 3e 12 80 	movl   $0x80123e,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fcb:	e8 fd f2 ff ff       	call   8002cd <cprintf>

    yield();
  800fd0:	e8 5c f2 ff ff       	call   800231 <yield>
    yield();
  800fd5:	e8 57 f2 ff ff       	call   800231 <yield>
    yield();
  800fda:	e8 52 f2 ff ff       	call   800231 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  800fdf:	c7 04 24 10 14 80 00 	movl   $0x801410,(%esp)
  800fe6:	e8 e2 f2 ff ff       	call   8002cd <cprintf>

    assert((ret = kill(pid)) == 0);
  800feb:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  800fef:	89 04 24             	mov    %eax,(%esp)
  800ff2:	e8 47 f2 ff ff       	call   80023e <kill>
  ...
  801021:	e8 fa ef ff ff       	call   800020 <__panic>
  ...
  801035:	e8 93 f2 ff ff       	call   8002cd <cprintf>
  ...
  801049:	e8 c9 f1 ff ff       	call   800217 <waitpid>
  ...
  80108c:	e8 3c f2 ff ff       	call   8002cd <cprintf>

    cprintf("spin may pass.\n");
  801091:	c7 04 24 b5 14 80 00 	movl   $0x8014b5,(%esp)
  801098:	e8 30 f2 ff ff       	call   8002cd <cprintf>
    return 0;
