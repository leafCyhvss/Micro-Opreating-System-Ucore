...
main(void) {
  ...
  800ff1:	eb 60                	jmp    801053 <main+0x73>
        if ((pid = fork()) == 0) {
  800ff3:	e8 25 f2 ff ff       	call   80021d <fork>
  ...
  801012:	e8 05 f3 ff ff       	call   80031c <cprintf>
            exit(0);
  801017:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80101e:	e8 db f1 ff ff       	call   8001fe <exit>
        }
        assert(pid > 0);
  ...
  801049:	e8 d2 ef ff ff       	call   800020 <__panic>
    for (n = 0; n < max_child; n ++) {
  ...
  801088:	e8 93 ef ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
  80108d:	eb 2a                	jmp    8010b9 <main+0xd9>
        if (wait() != 0) {
  80108f:	e8 96 f1 ff ff       	call   80022a <wait>
  ...
  8010af:	e8 6c ef ff ff       	call   800020 <__panic>
    for (; n > 0; n --) {
  ...
  8010be:	7f cf                	jg     80108f <main+0xaf>
    ...
    if (wait() == 0) {
  8010c0:	e8 65 f1 ff ff       	call   80022a <wait>
  ...
  8010e0:	e8 3b ef ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  8010e5:	c7 04 24 67 14 80 00 	movl   $0x801467,(%esp)
  8010ec:	e8 2b f2 ff ff       	call   80031c <cprintf>
    return 0;
