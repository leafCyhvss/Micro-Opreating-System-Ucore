...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 40 10 80 00 	movl   $0x801040,(%esp)
  ...
  800053:	e8 91 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 5a 10 80 00 	movl   $0x80105a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 5c 10 80 00 	movl   $0x80105c,(%esp)
  ...
  8000a3:	e8 41 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 5a 10 80 00 	movl   $0x80105a,(%esp)
...
exit(int error_code) {
  ...
  80020f:	c7 04 24 78 10 80 00 	movl   $0x801078,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 a4 11 80 00       	add    $0x8011a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 c8 11 80 00 	mov    0x8011c8(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 be 11 80 	movl   $0x8011be,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be c1 11 80 00       	mov    $0x8011c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801002:	e8 15 f3 ff ff       	call   80031c <cprintf>
    panic("FAIL: T.T\n");
  ...
  80101e:	e8 fd ef ff ff       	call   800020 <__panic>
