...
exit(int error_code) {
  ...
  80020f:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 3e 12 80 	movl   $0x80123e,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
forkchild(const char *cur, char branch) {
  ...
  800ff2:	e8 b3 f3 ff ff       	call   8003aa <strlen>
  ...
  801021:	e8 25 fe ff ff       	call   800e4b <snprintf>
    if (fork() == 0) {
  801026:	e8 f2 f1 ff ff       	call   80021d <fork>
  ...
  801035:	e8 13 00 00 00       	call   80104d <forktree>
        yield();
  80103a:	e8 21 f2 ff ff       	call   800260 <yield>
        exit(0);
  80103f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801046:	e8 b3 f1 ff ff       	call   8001fe <exit>
    }
}
  80104b:	c9                   	leave  
  80104c:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  801050:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801053:	e8 28 f2 ff ff       	call   800280 <getpid>
  ...
  80106a:	e8 ad f2 ff ff       	call   80031c <cprintf>
