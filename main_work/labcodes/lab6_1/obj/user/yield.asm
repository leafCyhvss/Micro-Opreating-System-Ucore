...
exit(int error_code) {
  ...
  80020f:	c7 04 24 98 10 80 00 	movl   $0x801098,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 c4 11 80 00       	add    $0x8011c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 e8 11 80 00 	mov    0x8011e8(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 de 11 80 	movl   $0x8011de,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be e1 11 80 00       	mov    $0x8011e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801025:	e8 f2 f2 ff ff       	call   80031c <cprintf>
    for (i = 0; i < 5; i ++) {
