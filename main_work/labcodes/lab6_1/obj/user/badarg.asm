...
exit(int error_code) {
  ...
  80020f:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fe6:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800fe9:	e8 2f f2 ff ff       	call   80021d <fork>
  ...
  801000:	e8 17 f3 ff ff       	call   80031c <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  ...
  80100d:	eb 0a                	jmp    801019 <main+0x39>
            yield();
  80100f:	e8 4c f2 ff ff       	call   800260 <yield>
        for (i = 0; i < 10; i ++) {
  ...
  801027:	e8 d2 f1 ff ff       	call   8001fe <exit>
    }
    assert(pid > 0);
  ...
  8010a2:	e8 9f f1 ff ff       	call   800246 <waitpid>
  ...
  8010ca:	e8 51 ef ff ff       	call   800020 <__panic>
  ...
  8010de:	e8 63 f1 ff ff       	call   800246 <waitpid>
  ...
  801111:	e8 0a ef ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  801116:	c7 04 24 c9 14 80 00 	movl   $0x8014c9,(%esp)
  80111d:	e8 fa f1 ff ff       	call   80031c <cprintf>
    return 0;
