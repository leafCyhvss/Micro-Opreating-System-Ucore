...
exit(int error_code) {
  ...
  80022a:	c7 04 24 d8 10 80 00 	movl   $0x8010d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 04 12 80 00       	add    $0x801204,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 28 12 80 00 	mov    0x801228(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 1e 12 80 	movl   $0x80121e,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 21 12 80 00       	mov    $0x801221,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801053:	e8 f2 f2 ff ff       	call   80034a <cprintf>
    for (i = 0; i < 5; i ++) {
