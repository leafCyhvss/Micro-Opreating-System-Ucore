...
main(void) {
  ...
  80102e:	e8 17 f3 ff ff       	call   80034a <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  ...
  80103b:	eb 0a                	jmp    801047 <main+0x39>
            yield();
  80103d:	e8 39 f2 ff ff       	call   80027b <yield>
        for (i = 0; i < 10; i ++) {
  ...
  801055:	e8 bf f1 ff ff       	call   800219 <exit>
    }
    assert(pid > 0);
  ...
  8010bc:	e8 5f ef ff ff       	call   800020 <__panic>
  ...
  8010d0:	e8 8c f1 ff ff       	call   800261 <waitpid>
  ...
  8010f8:	e8 23 ef ff ff       	call   800020 <__panic>
  ...
  80110c:	e8 50 f1 ff ff       	call   800261 <waitpid>
  ...
  80113f:	e8 dc ee ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  801144:	c7 04 24 e9 14 80 00 	movl   $0x8014e9,(%esp)
  80114b:	e8 fa f1 ff ff       	call   80034a <cprintf>
    return 0;
