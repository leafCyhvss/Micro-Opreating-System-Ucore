...
exit(int error_code) {
  ...
  80022a:	c7 04 24 98 10 80 00 	movl   $0x801098,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 c4 11 80 00       	add    $0x8011c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 e8 11 80 00 	mov    0x8011e8(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 de 11 80 	movl   $0x8011de,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be e1 11 80 00       	mov    $0x8011e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801027:	e8 1e f3 ff ff       	call   80034a <cprintf>
    print_pgdir();
  80102c:	e8 77 f2 ff ff       	call   8002a8 <print_pgdir>
    cprintf("pgdir pass.\n");
  801031:	c7 04 24 57 13 80 00 	movl   $0x801357,(%esp)
  801038:	e8 0d f3 ff ff       	call   80034a <cprintf>
    return 0;
