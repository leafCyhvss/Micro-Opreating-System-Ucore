...
exit(int error_code) {
  ...
  80022a:	c7 04 24 78 11 80 00 	movl   $0x801178,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 a4 12 80 00       	add    $0x8012a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 c8 12 80 00 	mov    0x8012c8(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 be 12 80 	movl   $0x8012be,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be c1 12 80 00       	mov    $0x8012c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80101f:	eb 60                	jmp    801081 <main+0x73>
        if ((pid = fork()) == 0) {
  801021:	e8 12 f2 ff ff       	call   800238 <fork>
  ...
  801040:	e8 05 f3 ff ff       	call   80034a <cprintf>
            exit(0);
  801045:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  80104c:	e8 c8 f1 ff ff       	call   800219 <exit>
        }
        assert(pid > 0);
  ...
  801077:	e8 a4 ef ff ff       	call   800020 <__panic>
    for (n = 0; n < max_child; n ++) {
  ...
  8010b6:	e8 65 ef ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
  8010bb:	eb 2a                	jmp    8010e7 <main+0xd9>
        if (wait() != 0) {
  8010bd:	e8 83 f1 ff ff       	call   800245 <wait>
  ...
  8010ec:	7f cf                	jg     8010bd <main+0xaf>
    ...
    if (wait() == 0) {
  8010ee:	e8 52 f1 ff ff       	call   800245 <wait>
  ...
  80110e:	e8 0d ef ff ff       	call   800020 <__panic>
    }

    cprintf("forktest pass.\n");
  801113:	c7 04 24 a7 14 80 00 	movl   $0x8014a7,(%esp)
  80111a:	e8 2b f2 ff ff       	call   80034a <cprintf>
    return 0;
