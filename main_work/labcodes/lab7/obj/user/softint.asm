...
exit(int error_code) {
  ...
  80022a:	c7 04 24 78 10 80 00 	movl   $0x801078,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 a4 11 80 00       	add    $0x8011a4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 c8 11 80 00 	mov    0x8011c8(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 be 11 80 	movl   $0x8011be,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be c1 11 80 00       	mov    $0x8011c1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801030:	e8 eb ef ff ff       	call   800020 <__panic>
