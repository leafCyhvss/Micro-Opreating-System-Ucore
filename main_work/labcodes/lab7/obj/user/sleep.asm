...
exit(int error_code) {
  ...
  80022a:	c7 04 24 38 11 80 00 	movl   $0x801138,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
sleepy(int pid) {
  ...
  80102a:	e8 a6 f2 ff ff       	call   8002d5 <sleep>
  ...
  801047:	e8 fe f2 ff ff       	call   80034a <cprintf>
    for (i = 0; i < 10; i ++) {
  ...
  80105d:	e8 b7 f1 ff ff       	call   800219 <exit>
...
main(void) {
  ...
  80106b:	e8 45 f2 ff ff       	call   8002b5 <gettime_msec>
  801070:	89 44 24 1c          	mov    %eax,0x1c(%esp)
    int pid1, exit_code;

    if ((pid1 = fork()) == 0) {
  801074:	e8 bf f1 ff ff       	call   800238 <fork>
  ...
  80109f:	e8 bd f1 ff ff       	call   800261 <waitpid>
