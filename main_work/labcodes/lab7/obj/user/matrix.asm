...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800053:	e8 bf 02 00 00       	call   800317 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 1a 14 80 00 	movl   $0x80141a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 1c 14 80 00 	movl   $0x80141c,(%esp)
  ...
  8000a3:	e8 6f 02 00 00       	call   800317 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 1a 14 80 00 	movl   $0x80141a,(%esp)
...
exit(int error_code) {
  ...
  80022a:	c7 04 24 38 14 80 00 	movl   $0x801438,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 64 15 80 00       	add    $0x801564,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 88 15 80 00 	mov    0x801588(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 7e 15 80 	movl   $0x80157e,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 81 15 80 00       	mov    $0x801581,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  801090:	7c 93                	jl     801025 <work+0x17>
    ...
    yield();
  801092:	e8 e4 f1 ff ff       	call   80027b <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801097:	e8 ff f1 ff ff       	call   80029b <getpid>
  ...
  8010ae:	e8 97 f2 ff ff       	call   80034a <cprintf>
  ...
  80121f:	0f 85 93 fe ff ff    	jne    8010b8 <work+0xaa>
    ...
    cprintf("pid %d done!.\n", getpid());
  801225:	e8 71 f0 ff ff       	call   80029b <getpid>
  80122a:	89 44 24 04          	mov    %eax,0x4(%esp)
  80122e:	c7 04 24 00 17 80 00 	movl   $0x801700,(%esp)
  801235:	e8 10 f1 ff ff       	call   80034a <cprintf>
    exit(0);
  80123a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801241:	e8 d3 ef ff ff       	call   800219 <exit>
...
main(void) {
  ...
  8012bc:	e8 46 f4 ff ff       	call   800707 <memset>
  ...
  8012c8:	eb 70                	jmp    80133a <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  8012ca:	e8 69 ef ff ff       	call   800238 <fork>
  ...
  8012ef:	e8 02 fd ff ff       	call   800ff6 <srand>
            int times = (((unsigned int)rand()) % total);
  8012f4:	e8 3d fc ff ff       	call   800f36 <rand>
  ...
  801385:	e8 c0 ef ff ff       	call   80034a <cprintf>
    return 0;
...
failed:
  ...
  8013b5:	e8 ce ee ff ff       	call   800288 <kill>
    for (i = 0; i < total; i ++) {
  ...
  8013df:	e8 3c ec ff ff       	call   800020 <__panic>
}
