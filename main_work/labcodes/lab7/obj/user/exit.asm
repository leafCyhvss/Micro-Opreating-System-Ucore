...
exit(int error_code) {
  ...
  80022a:	c7 04 24 b8 11 80 00 	movl   $0x8011b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 e4 12 80 00       	add    $0x8012e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 08 13 80 00 	mov    0x801308(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 fe 12 80 	movl   $0x8012fe,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 01 13 80 00       	mov    $0x801301,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80103a:	e8 0b f3 ff ff       	call   80034a <cprintf>
        yield();
  80103f:	e8 37 f2 ff ff       	call   80027b <yield>
        yield();
  801044:	e8 32 f2 ff ff       	call   80027b <yield>
        yield();
  801049:	e8 2d f2 ff ff       	call   80027b <yield>
        yield();
  80104e:	e8 28 f2 ff ff       	call   80027b <yield>
        yield();
  801053:	e8 23 f2 ff ff       	call   80027b <yield>
        yield();
  801058:	e8 1e f2 ff ff       	call   80027b <yield>
        yield();
  80105d:	e8 19 f2 ff ff       	call   80027b <yield>
        exit(magic);
  801062:	a1 08 20 80 00       	mov    0x802008,%eax
  801067:	89 04 24             	mov    %eax,(%esp)
  80106a:	e8 aa f1 ff ff       	call   800219 <exit>
    }
    else {
  ...
  80107e:	e8 c7 f2 ff ff       	call   80034a <cprintf>
    }
    assert(pid > 0);
  ...
  8010a9:	e8 72 ef ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  8010ae:	c7 04 24 e4 14 80 00 	movl   $0x8014e4,(%esp)
  8010b5:	e8 90 f2 ff ff       	call   80034a <cprintf>
  ...
  8010c9:	e8 93 f1 ff ff       	call   800261 <waitpid>
  ...
  8010fe:	e8 1d ef ff ff       	call   800020 <__panic>
  ...
  801112:	e8 4a f1 ff ff       	call   800261 <waitpid>
  801117:	85 c0                	test   %eax,%eax
  801119:	74 09                	je     801124 <main+0x116>
  80111b:	e8 25 f1 ff ff       	call   800245 <wait>
