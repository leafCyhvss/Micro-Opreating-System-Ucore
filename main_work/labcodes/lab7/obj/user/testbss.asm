...
main(void) {
  ...
  8010d3:	e8 48 ef ff ff       	call   800020 <__panic>
    for (i = 0; i < ARRAYSIZE; i ++) {
  ...
  8010ee:	e8 57 f2 ff ff       	call   80034a <cprintf>
    cprintf("testbss may pass.\n");
  8010f3:	c7 04 24 c7 14 80 00 	movl   $0x8014c7,(%esp)
  8010fa:	e8 4b f2 ff ff       	call   80034a <cprintf>
  ...
  801122:	e8 f9 ee ff ff       	call   800020 <__panic>
