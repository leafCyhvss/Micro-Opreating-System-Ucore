...
exit(int error_code) {
  ...
  80022a:	c7 04 24 f8 10 80 00 	movl   $0x8010f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 24 12 80 00       	add    $0x801224,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 48 12 80 00 	mov    0x801248(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 3e 12 80 	movl   $0x80123e,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 41 12 80 00       	mov    $0x801241,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801014:	83 ec 20             	sub    $0x20,%esp
    int pid;
    if ((pid = fork()) == 0) {
  801017:	e8 1c f2 ff ff       	call   800238 <fork>
  ...
  80102e:	e8 a2 f2 ff ff       	call   8002d5 <sleep>
        exit(0xdead);
  801033:	c7 04 24 ad de 00 00 	movl   $0xdead,(%esp)
  80103a:	e8 da f1 ff ff       	call   800219 <exit>
    }
    assert(pid > 0);
  ...
  801065:	e8 b6 ef ff ff       	call   800020 <__panic>

    sleep(100);
  80106a:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  801071:	e8 5f f2 ff ff       	call   8002d5 <sleep>
    assert(kill(pid) == 0);
  801076:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80107a:	89 04 24             	mov    %eax,(%esp)
  80107d:	e8 06 f2 ff ff       	call   800288 <kill>
  ...
  8010b1:	e8 94 f2 ff ff       	call   80034a <cprintf>
    return 0;
