...
forkchild(const char *cur, char branch) {
  ...
  801020:	e8 b3 f3 ff ff       	call   8003d8 <strlen>
  ...
  80104f:	e8 25 fe ff ff       	call   800e79 <snprintf>
    if (fork() == 0) {
  801054:	e8 df f1 ff ff       	call   800238 <fork>
  ...
  801063:	e8 13 00 00 00       	call   80107b <forktree>
        yield();
  801068:	e8 0e f2 ff ff       	call   80027b <yield>
        exit(0);
  80106d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801074:	e8 a0 f1 ff ff       	call   800219 <exit>
    }
}
  801079:	c9                   	leave  
  80107a:	c3                   	ret    
...
forktree(const char *cur) {
  ...
  80107e:	83 ec 18             	sub    $0x18,%esp
    cprintf("%04x: I am '%s'\n", getpid(), cur);
  801081:	e8 15 f2 ff ff       	call   80029b <getpid>
  ...
  801098:	e8 ad f2 ff ff       	call   80034a <cprintf>
