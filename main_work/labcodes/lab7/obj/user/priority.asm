...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800053:	e8 bf 02 00 00       	call   800317 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 1a 13 80 00 	movl   $0x80131a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 1c 13 80 00 	movl   $0x80131c,(%esp)
  ...
  8000a3:	e8 6f 02 00 00       	call   800317 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 1a 13 80 00 	movl   $0x80131a,(%esp)
...
exit(int error_code) {
  ...
  80022a:	c7 04 24 38 13 80 00 	movl   $0x801338,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 64 14 80 00       	add    $0x801464,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 88 14 80 00 	mov    0x801488(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 7e 14 80 	movl   $0x80147e,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 81 14 80 00       	mov    $0x801481,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  801054:	e8 f1 f2 ff ff       	call   80034a <cprintf>
     sleep(SLEEP_TIME);
  801059:	c7 04 24 90 01 00 00 	movl   $0x190,(%esp)
  801060:	e8 70 f2 ff ff       	call   8002d5 <sleep>
  ...
  80107c:	e8 86 f6 ff ff       	call   800707 <memset>
     lab6_set_priority(TOTAL + 1);
  801081:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  801088:	e8 35 f2 ff ff       	call   8002c2 <lab6_set_priority>
  ...
  8010a5:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  8010a9:	e8 8a f1 ff ff       	call   800238 <fork>
  ...
  8010d6:	e8 e7 f1 ff ff       	call   8002c2 <lab6_set_priority>
               acc[i] = 0;
  ...
  80112f:	e8 81 f1 ff ff       	call   8002b5 <gettime_msec>
  ...
  80114d:	e8 49 f1 ff ff       	call   80029b <getpid>
...
failed:
  ...
  8011ba:	e8 8b f1 ff ff       	call   80034a <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  ...
  8011f7:	e8 65 f0 ff ff       	call   800261 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8011fc:	e8 b4 f0 ff ff       	call   8002b5 <gettime_msec>
  ...
  80122a:	e8 1b f1 ff ff       	call   80034a <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  ...
  801242:	e8 03 f1 ff ff       	call   80034a <cprintf>
     cprintf("stride sched correct result:");
  801247:	c7 04 24 85 16 80 00 	movl   $0x801685,(%esp)
  80124e:	e8 f7 f0 ff ff       	call   80034a <cprintf>
     for (i = 0; i < TOTAL; i ++)
  ...
  80128a:	e8 bb f0 ff ff       	call   80034a <cprintf>
     for (i = 0; i < TOTAL; i ++)
  ...
  8012a2:	e8 a3 f0 ff ff       	call   80034a <cprintf>
     return 0;
  ...
  8012cb:	e8 b8 ef ff ff       	call   800288 <kill>
     for (i = 0; i < TOTAL; i ++) {
  ...
  8012f3:	e8 28 ed ff ff       	call   800020 <__panic>
}
