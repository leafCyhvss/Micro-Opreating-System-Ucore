...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 a0 11 80 00 	movl   $0x8011a0,(%esp)
  ...
  800053:	e8 bf 02 00 00       	call   800317 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 bc 11 80 00 	movl   $0x8011bc,(%esp)
  ...
  8000a3:	e8 6f 02 00 00       	call   800317 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 ba 11 80 00 	movl   $0x8011ba,(%esp)
...
exit(int error_code) {
  ...
  80022a:	c7 04 24 d8 11 80 00 	movl   $0x8011d8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800979:	05 04 13 80 00       	add    $0x801304,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800ac8:	8b 04 85 28 13 80 00 	mov    0x801328(,%eax,4),%eax
  ...
  800bd3:	c7 44 24 08 1e 13 80 	movl   $0x80131e,0x8(%esp)
  800bda:	00 
  ...
  800bff:	75 05                	jne    800c06 <vprintfmt+0x1ad>
                p = "(null)";
  800c01:	be 21 13 80 00       	mov    $0x801321,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  801011:	83 ec 08             	sub    $0x8,%esp
    yield();
  801014:	e8 62 f2 ff ff       	call   80027b <yield>
    yield();
  801019:	e8 5d f2 ff ff       	call   80027b <yield>
    yield();
  80101e:	e8 58 f2 ff ff       	call   80027b <yield>
    yield();
  801023:	e8 53 f2 ff ff       	call   80027b <yield>
    yield();
  801028:	e8 4e f2 ff ff       	call   80027b <yield>
    yield();
  80102d:	e8 49 f2 ff ff       	call   80027b <yield>
}
  801032:	c9                   	leave  
  801033:	c3                   	ret    
...
loop(void) {
  ...
  801041:	e8 04 f3 ff ff       	call   80034a <cprintf>
    while (1);
...
main(void) {
  ...
  8010bc:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  8010bf:	e8 d7 f1 ff ff       	call   80029b <getpid>
  8010c4:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  8010c9:	e8 6a f1 ff ff       	call   800238 <fork>
  ...
  801109:	e8 12 ef ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  80110e:	e8 25 f1 ff ff       	call   800238 <fork>
  ...
  801170:	e8 ab ee ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  801175:	a1 10 20 80 00       	mov    0x802010,%eax
  80117a:	89 04 24             	mov    %eax,(%esp)
  80117d:	e8 06 f1 ff ff       	call   800288 <kill>
    }
    panic("FAIL: T.T\n");
  ...
  801199:	e8 82 ee ff ff       	call   800020 <__panic>
