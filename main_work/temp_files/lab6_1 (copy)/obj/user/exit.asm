...
exit(int error_code) {
  ...
  80020f:	c7 04 24 98 11 80 00 	movl   $0x801198,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 c4 12 80 00       	add    $0x8012c4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 e8 12 80 00 	mov    0x8012e8(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 de 12 80 	movl   $0x8012de,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be e1 12 80 00       	mov    $0x8012e1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ff0:	e8 27 f3 ff ff       	call   80031c <cprintf>
    if ((pid = fork()) == 0) {
  800ff5:	e8 23 f2 ff ff       	call   80021d <fork>
  ...
  80100c:	e8 0b f3 ff ff       	call   80031c <cprintf>
        yield();
  801011:	e8 4a f2 ff ff       	call   800260 <yield>
        yield();
  801016:	e8 45 f2 ff ff       	call   800260 <yield>
        yield();
  80101b:	e8 40 f2 ff ff       	call   800260 <yield>
        yield();
  801020:	e8 3b f2 ff ff       	call   800260 <yield>
        yield();
  801025:	e8 36 f2 ff ff       	call   800260 <yield>
        yield();
  80102a:	e8 31 f2 ff ff       	call   800260 <yield>
        yield();
  80102f:	e8 2c f2 ff ff       	call   800260 <yield>
        exit(magic);
  801034:	a1 08 20 80 00       	mov    0x802008,%eax
  801039:	89 04 24             	mov    %eax,(%esp)
  80103c:	e8 bd f1 ff ff       	call   8001fe <exit>
    }
    else {
  ...
  801050:	e8 c7 f2 ff ff       	call   80031c <cprintf>
    }
    assert(pid > 0);
  ...
  80107b:	e8 a0 ef ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801080:	c7 04 24 c4 14 80 00 	movl   $0x8014c4,(%esp)
  801087:	e8 90 f2 ff ff       	call   80031c <cprintf>
  ...
  80109b:	e8 a6 f1 ff ff       	call   800246 <waitpid>
  ...
  8010d0:	e8 4b ef ff ff       	call   800020 <__panic>
  ...
  8010e4:	e8 5d f1 ff ff       	call   800246 <waitpid>
  8010e9:	85 c0                	test   %eax,%eax
  8010eb:	74 09                	je     8010f6 <main+0x116>
  8010ed:	e8 38 f1 ff ff       	call   80022a <wait>
