...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800053:	e8 91 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 da 12 80 00 	movl   $0x8012da,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 dc 12 80 00 	movl   $0x8012dc,(%esp)
  ...
  8000a3:	e8 41 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 da 12 80 00 	movl   $0x8012da,(%esp)
...
exit(int error_code) {
  ...
  80020f:	c7 04 24 f8 12 80 00 	movl   $0x8012f8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 24 14 80 00       	add    $0x801424,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 48 14 80 00 	mov    0x801448(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 3e 14 80 	movl   $0x80143e,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be 41 14 80 00       	mov    $0x801441,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  80102e:	e8 a6 f6 ff ff       	call   8006d9 <memset>
     lab6_set_priority(TOTAL + 1);
  801033:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
  80103a:	e8 68 f2 ff ff       	call   8002a7 <lab6_set_priority>
  ...
  801057:	00 00 00 00 
          if ((pids[i] = fork()) == 0) {
  80105b:	e8 bd f1 ff ff       	call   80021d <fork>
  ...
  801088:	e8 1a f2 ff ff       	call   8002a7 <lab6_set_priority>
               acc[i] = 0;
  ...
  8010e1:	e8 b4 f1 ff ff       	call   80029a <gettime_msec>
  ...
  8010ff:	e8 7c f1 ff ff       	call   800280 <getpid>
...
failed:
  ...
  80116c:	e8 ab f1 ff ff       	call   80031c <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  ...
  8011a9:	e8 98 f0 ff ff       	call   800246 <waitpid>
         cprintf("main: pid %d, acc %d, time %d\n",pids[i],status[i],gettime_msec()); 
  8011ae:	e8 e7 f0 ff ff       	call   80029a <gettime_msec>
  ...
  8011dc:	e8 3b f1 ff ff       	call   80031c <cprintf>
     for (i = 0; i < TOTAL; i ++) {
  ...
  8011f4:	e8 23 f1 ff ff       	call   80031c <cprintf>
     cprintf("stride sched correct result:");
  8011f9:	c7 04 24 1d 16 80 00 	movl   $0x80161d,(%esp)
  801200:	e8 17 f1 ff ff       	call   80031c <cprintf>
     for (i = 0; i < TOTAL; i ++)
  ...
  80123c:	e8 db f0 ff ff       	call   80031c <cprintf>
     for (i = 0; i < TOTAL; i ++)
  ...
  801254:	e8 c3 f0 ff ff       	call   80031c <cprintf>
     return 0;
  ...
  80127d:	e8 eb ef ff ff       	call   80026d <kill>
     for (i = 0; i < TOTAL; i ++) {
  ...
  8012a5:	e8 76 ed ff ff       	call   800020 <__panic>
}
