...
main(void) {
  ...
  80101a:	e8 fd f2 ff ff       	call   80031c <cprintf>

    yield();
  80101f:	e8 3c f2 ff ff       	call   800260 <yield>
    yield();
  801024:	e8 37 f2 ff ff       	call   800260 <yield>
    yield();
  801029:	e8 32 f2 ff ff       	call   800260 <yield>

    cprintf("I am the parent.  Killing the child...\n");
  80102e:	c7 04 24 50 14 80 00 	movl   $0x801450,(%esp)
  801035:	e8 e2 f2 ff ff       	call   80031c <cprintf>

    assert((ret = kill(pid)) == 0);
  80103a:	8b 44 24 1c          	mov    0x1c(%esp),%eax
  80103e:	89 04 24             	mov    %eax,(%esp)
  801041:	e8 27 f2 ff ff       	call   80026d <kill>
  ...
  801070:	e8 ab ef ff ff       	call   800020 <__panic>
  ...
  801084:	e8 93 f2 ff ff       	call   80031c <cprintf>
  ...
  801098:	e8 a9 f1 ff ff       	call   800246 <waitpid>
  ...
  8010db:	e8 3c f2 ff ff       	call   80031c <cprintf>

    cprintf("spin may pass.\n");
  8010e0:	c7 04 24 f5 14 80 00 	movl   $0x8014f5,(%esp)
  8010e7:	e8 30 f2 ff ff       	call   80031c <cprintf>
    return 0;
