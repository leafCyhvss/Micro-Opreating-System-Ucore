...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 e0 13 80 00 	movl   $0x8013e0,(%esp)
  ...
  800053:	e8 91 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 fa 13 80 00 	movl   $0x8013fa,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 fc 13 80 00 	movl   $0x8013fc,(%esp)
  ...
  8000a3:	e8 41 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 fa 13 80 00 	movl   $0x8013fa,(%esp)
...
exit(int error_code) {
  ...
  80020f:	c7 04 24 18 14 80 00 	movl   $0x801418,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 44 15 80 00       	add    $0x801544,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 68 15 80 00 	mov    0x801568(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 5e 15 80 	movl   $0x80155e,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be 61 15 80 00       	mov    $0x801561,%esi
            }
            if (width > 0 && padc != '-') {
...
work(unsigned int times) {
  ...
  801062:	7c 93                	jl     800ff7 <work+0x17>
    ...
    yield();
  801064:	e8 f7 f1 ff ff       	call   800260 <yield>

    cprintf("pid %d is running (%d times)!.\n", getpid(), times);
  801069:	e8 12 f2 ff ff       	call   800280 <getpid>
  ...
  801080:	e8 97 f2 ff ff       	call   80031c <cprintf>
  ...
  8011f1:	0f 85 93 fe ff ff    	jne    80108a <work+0xaa>
    ...
    cprintf("pid %d done!.\n", getpid());
  8011f7:	e8 84 f0 ff ff       	call   800280 <getpid>
  8011fc:	89 44 24 04          	mov    %eax,0x4(%esp)
  801200:	c7 04 24 e0 16 80 00 	movl   $0x8016e0,(%esp)
  801207:	e8 10 f1 ff ff       	call   80031c <cprintf>
    exit(0);
  80120c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801213:	e8 e6 ef ff ff       	call   8001fe <exit>
...
main(void) {
  ...
  80128e:	e8 46 f4 ff ff       	call   8006d9 <memset>
  ...
  80129a:	eb 70                	jmp    80130c <main+0xf4>
        if ((pids[i] = fork()) == 0) {
  80129c:	e8 7c ef ff ff       	call   80021d <fork>
  ...
  8012c1:	e8 02 fd ff ff       	call   800fc8 <srand>
            int times = (((unsigned int)rand()) % total);
  8012c6:	e8 3d fc ff ff       	call   800f08 <rand>
  ...
  801357:	e8 c0 ef ff ff       	call   80031c <cprintf>
    return 0;
...
failed:
  ...
  801387:	e8 e1 ee ff ff       	call   80026d <kill>
    for (i = 0; i < total; i ++) {
  ...
  8013b1:	e8 6a ec ff ff       	call   800020 <__panic>
}
