...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 80 11 80 00 	movl   $0x801180,(%esp)
  ...
  800053:	e8 91 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 9a 11 80 00 	movl   $0x80119a,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 9c 11 80 00 	movl   $0x80119c,(%esp)
  ...
  8000a3:	e8 41 02 00 00       	call   8002e9 <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 9a 11 80 00 	movl   $0x80119a,(%esp)
...
exit(int error_code) {
  ...
  80020f:	c7 04 24 b8 11 80 00 	movl   $0x8011b8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 e4 12 80 00       	add    $0x8012e4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 08 13 80 00 	mov    0x801308(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 fe 12 80 	movl   $0x8012fe,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be 01 13 80 00       	mov    $0x801301,%esi
            }
            if (width > 0 && padc != '-') {
...
do_yield(void) {
  ...
  800fe3:	83 ec 08             	sub    $0x8,%esp
    yield();
  800fe6:	e8 75 f2 ff ff       	call   800260 <yield>
    yield();
  800feb:	e8 70 f2 ff ff       	call   800260 <yield>
    yield();
  800ff0:	e8 6b f2 ff ff       	call   800260 <yield>
    yield();
  800ff5:	e8 66 f2 ff ff       	call   800260 <yield>
    yield();
  800ffa:	e8 61 f2 ff ff       	call   800260 <yield>
    yield();
  800fff:	e8 5c f2 ff ff       	call   800260 <yield>
}
  801004:	c9                   	leave  
  801005:	c3                   	ret    
...
loop(void) {
  ...
  801013:	e8 04 f3 ff ff       	call   80031c <cprintf>
    while (1);
...
work(void) {
  ...
  80106b:	e8 ac f2 ff ff       	call   80031c <cprintf>
            exit(0);
  801070:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  801077:	e8 82 f1 ff ff       	call   8001fe <exit>
        }
    }
    exit(-1);
  80107c:	c7 04 24 ff ff ff ff 	movl   $0xffffffff,(%esp)
  801083:	e8 76 f1 ff ff       	call   8001fe <exit>
...
main(void) {
  ...
  80108e:	83 ec 10             	sub    $0x10,%esp
    parent = getpid();
  801091:	e8 ea f1 ff ff       	call   800280 <getpid>
  801096:	a3 08 20 80 00       	mov    %eax,0x802008
    if ((pid1 = fork()) == 0) {
  80109b:	e8 7d f1 ff ff       	call   80021d <fork>
  ...
  8010db:	e8 40 ef ff ff       	call   800020 <__panic>

    if ((pid2 = fork()) == 0) {
  8010e0:	e8 38 f1 ff ff       	call   80021d <fork>
  ...
  801142:	e8 d9 ee ff ff       	call   800020 <__panic>
    }
    else {
        kill(pid1);
  801147:	a1 10 20 80 00       	mov    0x802010,%eax
  80114c:	89 04 24             	mov    %eax,(%esp)
  80114f:	e8 19 f1 ff ff       	call   80026d <kill>
    }
    panic("FAIL: T.T\n");
  ...
  80116b:	e8 b0 ee ff ff       	call   800020 <__panic>
