...
exit(int error_code) {
  ...
  80020f:	c7 04 24 58 10 80 00 	movl   $0x801058,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80094b:	05 84 11 80 00       	add    $0x801184,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a9a:	8b 04 85 a8 11 80 00 	mov    0x8011a8(,%eax,4),%eax
  ...
  800ba5:	c7 44 24 08 9e 11 80 	movl   $0x80119e,0x8(%esp)
  800bac:	00 
  ...
  800bd1:	75 05                	jne    800bd8 <vprintfmt+0x1ad>
                p = "(null)";
  800bd3:	be a1 11 80 00       	mov    $0x8011a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800ff9:	e8 1e f3 ff ff       	call   80031c <cprintf>
    print_pgdir();
  800ffe:	e8 8a f2 ff ff       	call   80028d <print_pgdir>
    cprintf("pgdir pass.\n");
  801003:	c7 04 24 17 13 80 00 	movl   $0x801317,(%esp)
  80100a:	e8 0d f3 ff ff       	call   80031c <cprintf>
    return 0;
