...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 38 11 80 00 	movl   $0x801138,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 64 12 80 00       	add    $0x801264,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 88 12 80 00 	mov    0x801288(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 7e 12 80 	movl   $0x80127e,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be 81 12 80 00       	mov    $0x801281,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fa1:	e8 27 f3 ff ff       	call   8002cd <cprintf>
    if ((pid = fork()) == 0) {
  800fa6:	e8 43 f2 ff ff       	call   8001ee <fork>
  ...
  800fbd:	e8 0b f3 ff ff       	call   8002cd <cprintf>
        yield();
  800fc2:	e8 6a f2 ff ff       	call   800231 <yield>
        yield();
  800fc7:	e8 65 f2 ff ff       	call   800231 <yield>
        yield();
  800fcc:	e8 60 f2 ff ff       	call   800231 <yield>
        yield();
  800fd1:	e8 5b f2 ff ff       	call   800231 <yield>
        yield();
  800fd6:	e8 56 f2 ff ff       	call   800231 <yield>
        yield();
  800fdb:	e8 51 f2 ff ff       	call   800231 <yield>
        yield();
  800fe0:	e8 4c f2 ff ff       	call   800231 <yield>
        exit(magic);
  800fe5:	a1 08 20 80 00       	mov    0x802008,%eax
  800fea:	89 04 24             	mov    %eax,(%esp)
  800fed:	e8 dd f1 ff ff       	call   8001cf <exit>
    }
    else {
  ...
  801001:	e8 c7 f2 ff ff       	call   8002cd <cprintf>
    }
    assert(pid > 0);
  ...
  80102c:	e8 ef ef ff ff       	call   800020 <__panic>
    cprintf("I am the parent, waiting now..\n");
  801031:	c7 04 24 64 14 80 00 	movl   $0x801464,(%esp)
  801038:	e8 90 f2 ff ff       	call   8002cd <cprintf>
  ...
  80104c:	e8 c6 f1 ff ff       	call   800217 <waitpid>
  ...
  801081:	e8 9a ef ff ff       	call   800020 <__panic>
  ...
  801095:	e8 7d f1 ff ff       	call   800217 <waitpid>
  80109a:	85 c0                	test   %eax,%eax
  80109c:	74 09                	je     8010a7 <main+0x116>
  80109e:	e8 58 f1 ff ff       	call   8001fb <wait>
