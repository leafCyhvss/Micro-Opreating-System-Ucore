...
main(void) {
  ...
  800fa2:	eb 60                	jmp    801004 <main+0x73>
        if ((pid = fork()) == 0) {
  800fa4:	e8 45 f2 ff ff       	call   8001ee <fork>
  ...
  800fc3:	e8 05 f3 ff ff       	call   8002cd <cprintf>
            exit(0);
  800fc8:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  800fcf:	e8 fb f1 ff ff       	call   8001cf <exit>
        }
        assert(pid > 0);
  ...
  800ffa:	e8 21 f0 ff ff       	call   800020 <__panic>
    for (n = 0; n < max_child; n ++) {
  ...
  801039:	e8 e2 ef ff ff       	call   800020 <__panic>
    }

    for (; n > 0; n --) {
  80103e:	eb 2a                	jmp    80106a <main+0xd9>
        if (wait() != 0) {
  801040:	e8 b6 f1 ff ff       	call   8001fb <wait>
  ...
  801060:	e8 bb ef ff ff       	call   800020 <__panic>
    for (; n > 0; n --) {
  ...
  80106f:	7f cf                	jg     801040 <main+0xaf>
    ...
    if (wait() == 0) {
  801071:	e8 85 f1 ff ff       	call   8001fb <wait>
  ...
  80109d:	e8 2b f2 ff ff       	call   8002cd <cprintf>
    return 0;
