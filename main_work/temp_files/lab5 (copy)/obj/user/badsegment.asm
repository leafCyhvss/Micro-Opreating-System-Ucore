...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	c7 04 24 c0 0f 80 00 	movl   $0x800fc0,(%esp)
  ...
  800053:	e8 42 02 00 00       	call   80029a <vcprintf>
    cprintf("\n");
  800058:	c7 04 24 da 0f 80 00 	movl   $0x800fda,(%esp)
...
__warn(const char *file, int line, const char *fmt, ...) {
  ...
  80008a:	c7 04 24 dc 0f 80 00 	movl   $0x800fdc,(%esp)
  ...
  8000a3:	e8 f2 01 00 00       	call   80029a <vcprintf>
    cprintf("\n");
  8000a8:	c7 04 24 da 0f 80 00 	movl   $0x800fda,(%esp)
...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 f8 0f 80 00 	movl   $0x800ff8,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 24 11 80 00       	add    $0x801124,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 48 11 80 00 	mov    0x801148(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 3e 11 80 	movl   $0x80113e,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be 41 11 80 00       	mov    $0x801141,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fb7:	e8 64 f0 ff ff       	call   800020 <__panic>
