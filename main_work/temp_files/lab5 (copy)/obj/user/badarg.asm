...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 18 11 80 00 	movl   $0x801118,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 44 12 80 00       	add    $0x801244,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 68 12 80 00 	mov    0x801268(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 5e 12 80 	movl   $0x80125e,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be 61 12 80 00       	mov    $0x801261,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800f97:	83 ec 20             	sub    $0x20,%esp
    int pid, exit_code;
    if ((pid = fork()) == 0) {
  800f9a:	e8 4f f2 ff ff       	call   8001ee <fork>
  ...
  800fb1:	e8 17 f3 ff ff       	call   8002cd <cprintf>
        int i;
        for (i = 0; i < 10; i ++) {
  ...
  800fbe:	eb 0a                	jmp    800fca <main+0x39>
            yield();
  800fc0:	e8 6c f2 ff ff       	call   800231 <yield>
        for (i = 0; i < 10; i ++) {
  ...
  800fd8:	e8 f2 f1 ff ff       	call   8001cf <exit>
    }
    assert(pid > 0);
  ...
  801053:	e8 bf f1 ff ff       	call   800217 <waitpid>
  ...
  80108f:	e8 83 f1 ff ff       	call   800217 <waitpid>
  ...
  8010c2:	e8 59 ef ff ff       	call   800020 <__panic>
    cprintf("badarg pass.\n");
  8010c7:	c7 04 24 69 14 80 00 	movl   $0x801469,(%esp)
  8010ce:	e8 fa f1 ff ff       	call   8002cd <cprintf>
    return 0;
