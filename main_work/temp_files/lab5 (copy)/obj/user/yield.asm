...
exit(int error_code) {
  ...
  8001e0:	c7 04 24 58 10 80 00 	movl   $0x801058,(%esp)
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  8008fc:	05 84 11 80 00       	add    $0x801184,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800a4b:	8b 04 85 a8 11 80 00 	mov    0x8011a8(,%eax,4),%eax
  ...
  800b56:	c7 44 24 08 9e 11 80 	movl   $0x80119e,0x8(%esp)
  800b5d:	00 
  ...
  800b82:	75 05                	jne    800b89 <vprintfmt+0x1ad>
                p = "(null)";
  800b84:	be a1 11 80 00       	mov    $0x8011a1,%esi
            }
            if (width > 0 && padc != '-') {
...
main(void) {
  ...
  800fd6:	e8 f2 f2 ff ff       	call   8002cd <cprintf>
    for (i = 0; i < 5; i ++) {
